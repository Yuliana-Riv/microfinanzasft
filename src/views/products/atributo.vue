    ...
    <div id="Atributos">
          ...
          <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> este atributo?</span></h3>
                </div>
...
import AddAtt from './addAtt.vue'
import EditAtt from './editAtt.vue'
export default {
  name: 'atributo',
  components:{
   AddAtt,
  ...
  computed:{
     data() {
         ...
         historyOption(){
            return this.$store.getters["atributo/getHistoryOption"]
        },
       ...
       ...mapActions('atributo', ['getAllInfoAtt']),
         ...
         ...mapActions('atributo', ['setAddedAtt']),
           ...
           changeView(option, item){
             this.item=item
             this.setAddedAtt(item)
             this.setHistoryOptionAtt(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("atributo/deleteItemAtt", {option: 'atributo', id:id});
