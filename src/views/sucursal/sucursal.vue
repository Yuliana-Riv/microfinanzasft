    ...
    <div id="Sucursal">
          ...
          <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> esta sucursal?</span></h3>
                </div>
...
import AddScl from './addScl.vue'
import editScl from './editScl.vue'
export default {
  name: 'Sucursal',
  components:{
   AddScl,
       ...
       ...mapActions('sucursal', ['getAllInfoScl']),
         ...
         ...mapActions('sucursal', ['setAddedScl']),
           ...
           changeView(option, item){
             this.item=item
             this.setAddedScl(item)
             this.setHistoryOptionScl(option)
         },
 ...
 includesItem(search, name) {
        ...
        eliminar: async function(){
            ...
            let result = await this.$store.dispatch("sucursal/deleteItemScl", {option: 'sucursal', id:id});
