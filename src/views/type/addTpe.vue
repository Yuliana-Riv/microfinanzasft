    ...
    methods:{
        ...
        submit: async function( name ){
           ...
           let data ={
                    ...
                    let result = await this.$store.dispatch("type/addItemTpe",  {option:'type', item: data});
                   
                    if(result.status=='error'){
                        this.status='error'
                        this.message= result.message
                    }else{ // success
                         this.setAddedTpe(result.added )
                       this.showModal()
