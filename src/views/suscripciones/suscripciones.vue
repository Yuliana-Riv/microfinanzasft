    ...
    <div id="Suscripciones">
          ...
          <div  id="navigate-buttons" class="mlf">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> esta suscripción?</span></h3>
                </div>
       ...
       ...mapActions('suscripciones', ['getAllInfoSbs']),
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("suscripciones/deleteItemSbs", {option: 'suscripciones', id:id});
