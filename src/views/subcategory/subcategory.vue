    ...
    <div id="Subcategory_view">
          ...
          <div  id="navigate-buttons" class="mlf2">
           ...
           <div v-if="viewModal" class="modal_view">
            ...
            <h3 >¿Estás seguro de  <span>eliminar <br> esta subcategoría?</span></h3>
                </div>
...
import AddSct from './addSct.vue'
import EditSct from './editSct.vue'
export default {
  ...
  computed:{
        data() {
           const arr = this.$store.getters["subcategory/data"];
  ...
  methods:{
         ...
         ...mapActions('subcategory', ['setAddedSct']),
           ...
           changeView(option, item){
             this.item=item
             this.setAddedSct(item)
             this.setHistoryOptionSct(option)
         },
        ...
        eliminar: async function(){
            ...
            this.message='';
             ...
             let result = await this.$store.dispatch("subcategory/deleteItemSct", {option: 'subcategory', id:id});
