...
export default {
    ...
    actions:{
        setAddedWish({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionWish({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoWish({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdWish({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchWish({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemWish({ commit }, payload) { 
        ...
        async editItemWish({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemWish({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
