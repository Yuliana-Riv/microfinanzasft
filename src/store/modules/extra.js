...
export default {
    ...
    actions:{
        setAddedExs({commit}, payload){
            commit(SET_ADDED, payload);  
        },
        
        setHistoryOptionExs({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoExs({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdExs({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchExs({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemExs({ commit }, payload) { 
        ...
        async editItemExs({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemExs({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
