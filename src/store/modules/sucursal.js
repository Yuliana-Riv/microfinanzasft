...
export default {
    ...
    actions:{
        setAddedScl({commit}, payload){
            commit(SET_ADDED, payload);  
        },
        
        setHistoryOptionScl({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoScl({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdScl({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchScl({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemScl({ commit }, payload) { 
        ...
        async editItemScl({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemScl({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
