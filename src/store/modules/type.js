...
export default {
    ...
    actions:{
        setAddedTpe({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionTpe({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoTpe({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdTpe({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchTpe({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemTpe({ commit }, payload) { 
        ...
        async editItemTpe({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemTpe({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
