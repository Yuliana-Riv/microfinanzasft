...
export default {
    ...
    actions:{
        setAddedCtg({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionCtg({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoCtg({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdCtg({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchCtg({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemCtg({ commit }, payload) { 
        ...
        async editItemCtg({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemCtg({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
