...
export default {
    ...
    actions:{
        setAddedPym({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionPym({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoPym({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdPym({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchPym({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemPym({ commit }, payload) { 
        ...
        async editItemPym({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemPym({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
