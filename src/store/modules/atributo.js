...
export default {
    ...
    actions:{
        setAddedAtt({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionAtt({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoAtt({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdAtt({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchAtt({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemAtt({ commit }, payload) { 
        ...
        async editItemAtt({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemAtt({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
