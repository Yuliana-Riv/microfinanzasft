...
export default {
    ...
    actions:{
        setAddedSct({commit}, payload){
            commit(SET_ADDED, payload);  
        },

        setHistoryOptionSct({commit}, payload){
            commit(SET_HISTORY_OPTION, payload);  
        },
        async getAllInfoSct({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
            //console.log(payload)
        ...
        async getInfoByIdSct({ commit }, payload) {
            commit(GETTING_INFO);
            try {              
                let token = userService.getToken() 
                let headers =  {'Authorization': token} ;
        ...
        async searchSct({ commit }, payload) {
            commit(GETTING_INFO);
            commit(GETTING_MSG);
        ...
        async deleteItemSct({ commit }, payload) { 
        ...
        async editItemSct({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
            try {               
                let token = userService.getToken() 
        ...
        async addItemSct({ commit }, payload) { 
            commit(SET_STATUS, 'SUCCESS')
